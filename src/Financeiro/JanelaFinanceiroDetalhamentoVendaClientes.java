...
import modelTabela.ModelRecebimento;
import Bin.Caixa;
import Bin.Cliente;
...
public class JanelaFinanceiroDetalhamentoVendaClientes extends JDialog
	...
	private ModelRecebimento model = new ModelRecebimento();
	 ...
	 * Create the dialog.
	 */
	public JanelaFinanceiroDetalhamentoVendaClientes(Cliente cliente) {
...
//		tabelaPagamentos.getColumn("Código").setPreferredWidth(70);
	...
	private void adiar() {
		try {
			...
			JanelaFinanceiroDetalhamentoData dg = new JanelaFinanceiroDetalhamentoData(
					recebimento);
	...
	private void detalhe() {
		...
		try {
			...
			Venda venda = (Venda) banco.buscarPorId(Venda.class,
					recebimento.getIdMovimento());
			JanelaFinanceiroDetalhamentoVendaClienteVerVenda dt = new JanelaFinanceiroDetalhamentoVendaClienteVerVenda(
					venda);
			dt.setVisible(true);
