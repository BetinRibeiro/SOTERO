...
public class PainelFinanceiroContasReceber extends JPanel implements
		ActionListener {

	private JPanel panelExibido =  new PainelFinanceiroContasReceberPendencias();
	 ...
	 * Create the frame.
	 */
	public PainelFinanceiroContasReceber() {
...
//		panelExibido.setLayout(null);
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Pendencias":
			remove(panelExibido);
			panelExibido = new PainelFinanceiroContasReceberPendencias();
			add(panelExibido);
		...
		case "Recebimentos":
			remove(panelExibido);
			panelExibido = new PainelFinanceiroContasReceberRecebimento();
			add(panelExibido);
			// parece que só pega com isso aqui nem sei exatamente o porque.
			invalidate();
			validate();
