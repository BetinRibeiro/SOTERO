...
import modelTabela.ModelClienteFinanceiroContasReceber;

@SuppressWarnings("serial")
public class PainelFinanceiroContasReceberRecebimento extends JPanel implements
		ActionListener {
	...
	ModelClienteFinanceiroContasReceber model = new ModelClienteFinanceiroContasReceber();
	 ...
	 * Create the panel.
	 */
	public PainelFinanceiroContasReceberRecebimento() {
		setLayout(null);
		// tamanho do painel
		...
		painalAgendamento = new PainelFinanceiroContasReceberRecebimentoAgendamento();
	...
	private void detalhe() {
		...
		JanelaFinanceiroDetalhamentoVendaClientes dt = new JanelaFinanceiroDetalhamentoVendaClientes(
				cliente);
		dt.setVisible(true);
		atualizarTabelaClientesDebito();
