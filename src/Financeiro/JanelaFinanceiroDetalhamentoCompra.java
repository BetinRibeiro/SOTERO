...
import modelTabela.ModelPagamento;
import modelTabela.ModelProdutosCarrinhoCompra;

@SuppressWarnings("serial")
public class JanelaFinanceiroDetalhamentoCompra extends JDialog implements
		ActionListener {
	...
	private ModelPagamento modelPagamento = new ModelPagamento();
	ModelProdutosCarrinhoCompra model = new ModelProdutosCarrinhoCompra();
	...
	public JanelaFinanceiroDetalhamentoCompra(Compra compraReferenciada) {
