...
public class PainelFinanceiroContasPagarPagamentos extends JPanel implements
		ActionListener {
	 ...
	 * Create the panel.
	 */
	public PainelFinanceiroContasPagarPagamentos() {
		setLayout(null);
		// tamanho do painel
		...
		painalAgendamento = new PainelFinanceiroContasPagarPagamentosAgendamento();
