...
public class JanelaFinanceiroDetalhamentoVenda extends JDialog implements
		ActionListener {
	...
	private ModelFinanceiroContasReceber modelVenda = new ModelFinanceiroContasReceber();
	 ...
	 * Create the dialog.
	 */
	public JanelaFinanceiroDetalhamentoVenda(Venda vendaReferenciada) {
