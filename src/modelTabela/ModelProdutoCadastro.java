...
public class ModelProdutoCadastro extends AbstractTableModel {

	private List<Produto> dados;
	private String[] colunas = { "Código","Descrição", "Classificação", "Quantidade", "Custo", "Preço" };
