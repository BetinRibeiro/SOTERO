...
public class ModelProdutoRelatorio extends AbstractTableModel {

	private List<Produto> dados;
	private String[] colunas = { "Código", "Descrição", "Custo",
			"Localização", "Preço", "Estoque Min", "Quantidade",
			"Classificação"};
	...
	public Object getValueAt(int linha, int coluna) {
		...
		case 3:
			return dados.get(linha).getLocalizacao();
		case 4:
			return df.format(dados.get(linha).getPreco());
		case 5:
			return dados.get(linha).getEstoqueMin();
		case 6:
