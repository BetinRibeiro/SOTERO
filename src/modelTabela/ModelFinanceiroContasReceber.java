...
public class ModelFinanceiroContasReceber extends AbstractTableModel {

	private List<Venda> dados;
	private String[] colunas = { "Código", "Descrição","Cliente","Valor", "Data"};
	...
	public ModelFinanceiroContasReceber() {
