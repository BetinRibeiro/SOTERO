...
public class ModelFinanceiroContasPagar extends AbstractTableModel {

	private List<Compra> dados;
	private String[] colunas = { "Código", "Descrição","Fornecedor",
			 "Valor", "Data"};
	...
	public ModelFinanceiroContasPagar() {
	...
	public Object getValueAt(int linha, int coluna) {
		...
		case 2:
			...
			Fornecedor fornecedor = (Fornecedor) banco.buscarPorId(Fornecedor.class, dados.get(linha).getFornecedor());
