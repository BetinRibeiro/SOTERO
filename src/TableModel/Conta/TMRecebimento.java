...
public class TMRecebimento extends AbstractTableModel {

	private List<Recebimento> dados;
	private String[] colunas = { "Código", "Especificação", "Descrição",
			"Valor", "Data"};
	...
	public TMRecebimento() {
		dados = new ArrayList<Recebimento>();

	}

	public void addRow(Recebimento p) {
