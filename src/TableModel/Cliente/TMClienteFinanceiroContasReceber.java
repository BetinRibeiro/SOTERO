...
public class TMClienteFinanceiroContasReceber extends AbstractTableModel {

	private List<Cliente> dados;
	private String[] colunas = { "Código", "Nome", "Apelido", "Telefone", "Divida"};
	...
	public TMClienteFinanceiroContasReceber() {
	...
	public Object getValueAt(int linha, int coluna) {
		...
		case 2:
			return dados.get(linha).getApelido();
		case 3:
			return dados.get(linha).getTelefone();
		case 4:
			return df.format(dados.get(linha).getDivida());
