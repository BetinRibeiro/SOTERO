...
public class TMCarrinhoCompra extends AbstractTableModel {

	private List<Produto> dados;
	private String[] colunas = {"Descrição", "Quant",
			"Custo", "Total",
			};
	...
	public Object getValueAt(int linha, int coluna) {
		...
		case 3:
			return df.format(dados.get(linha).getCusto()*dados.get(linha).getQuantidade());
		case 4:
