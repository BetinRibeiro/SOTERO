...
public class JVendaClienteVerVenda extends JDialog implements
		ActionListener {
	 ...
	 * Create the dialog.
	 */
	public JVendaClienteVerVenda(Venda vendaReferenciada) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Sair":
			...
			JVendaClientes jn = new JVendaClientes(cliente);
			jn.setVisible(true);
			break;
