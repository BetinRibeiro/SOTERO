...
public class JFrameVerVenda extends JDialog implements
		ActionListener {
	 ...
	 * Create the dialog.
	 */
	public JFrameVerVenda(Venda vendaReferenciada) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Sair":
			...
			JFrameVendaClientes jn = new JFrameVendaClientes(cliente);
			jn.setVisible(true);
			break;
