...
public class JFrameVendaClientes extends JDialog
	 ...
	 * Create the dialog.
	 */
	public JFrameVendaClientes(Cliente cliente) {
...
//		tabelaPagamentos.getColumn("Código").setPreferredWidth(70);
	...
	private void detalhe() {
		...
		try {
			...
			Venda venda = (Venda) banco.buscarPorId(Venda.class,
					recebimento.getIdMovimento());
			JFrameVerVenda dt = new JFrameVerVenda(
					venda);
			dt.setVisible(true);
