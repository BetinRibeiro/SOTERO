...
import ViewComercial.PainelComercialSecundarioCadastroCliente;
import ViewMaterial.PainelMaterialSecundarioCadastroFornecedor;
import ViewMaterial.PainelMaterialSecundarioCadastroProduto;

@SuppressWarnings("serial")
public class PainelPrincipalCadastroMenu extends JPanel implements ActionListener {
	//TODO - verificar os tratamentos de exceções, inserssão de numeros e valores não preenchidos
	
	JPanel painelEspecifico =  new PainelMaterialSecundarioCadastroProduto();

	/**
	 * Create the panel.
	 */

	public PainelPrincipalCadastroMenu() {
...
//		painelEspecifico.add(foto);
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Fornecedor":
			...
			painelEspecifico = new PainelMaterialSecundarioCadastroFornecedor();
		...
		case "Produto":
			remove(painelEspecifico);
			painelEspecifico = new PainelMaterialSecundarioCadastroProduto();
			add(painelEspecifico);
			// parece que só pega com isso aqui nem sei exatamente o porque.
			invalidate();
			validate();
		...
		case "Cliente":
			remove(painelEspecifico);
			painelEspecifico = new PainelComercialSecundarioCadastroCliente();
			add(painelEspecifico);
			// parece que só pega com isso aqui nem sei exatamente o porque.
			invalidate();
			validate();
