...
public class PainelPrincipalFinanceiro extends JPanel implements ActionListener {
	JPanel painelEspecifico = new PainelPrincipalFinanceiroContas();

	/**
	 * Create the panel.
	 */

	public PainelPrincipalFinanceiro() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Contas":
			...
			remove(painelEspecifico);
			 painelEspecifico = new PainelPrincipalFinanceiroContas();
