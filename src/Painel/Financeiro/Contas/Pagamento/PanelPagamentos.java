...
import Janela.Financeiro.Detalhamento.JCompra;
import Janela.Financeiro.Operacional.JEspecificarPagamento;
...
public class PanelPagamentos extends JPanel implements
		ActionListener {
	...
	public PanelPagamentos() {
		...
		painalAgendamento = new PanelAgendamento();
	...
	private void especificar() {
			...
			JEspecificarPagamento dt = new JEspecificarPagamento(
					compra);
			dt.setVisible(true);
			atualizarTabelaContas();
	...
	private void detalhe() {
		...
		JCompra janelaCompra = new JCompra(compra);
