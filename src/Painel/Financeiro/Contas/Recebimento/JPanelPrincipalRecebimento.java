...
public class JPanelPrincipalRecebimento extends JPanel implements
		ActionListener {

	private JPanel panelExibido =  new JPanelPendencias();
	 ...
	 * Create the frame.
	 */
	public JPanelPrincipalRecebimento() {
...
//		panelExibido.setLayout(null);
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Pendencias":
			remove(panelExibido);
			panelExibido = new JPanelPendencias();
			add(panelExibido);
		...
		case "Recebimentos":
			remove(panelExibido);
			panelExibido = new JPanelRecebimento();
			add(panelExibido);
			// parece que só pega com isso aqui nem sei exatamente o porque.
			invalidate();
			validate();
