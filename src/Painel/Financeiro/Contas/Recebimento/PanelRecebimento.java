...
import Bin.Cliente;
import Janela.Financeiro.Detalhamento.JVendaClientes;
...
public class PanelRecebimento extends JPanel implements
		ActionListener {
	...
	private void detalhe() {
		...
		JVendaClientes dt = new JVendaClientes(
				cliente);
		dt.setVisible(true);
		atualizarTabelaClientesDebito();
