...
public class JPanelPrincipalFinanceiro extends JPanel implements ActionListener {
	JPanel painelEspecifico = new JPanelPrincipalFinanceiroContas();

	/**
	 * Create the panel.
	 */

	public JPanelPrincipalFinanceiro() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Contas":
			...
			remove(painelEspecifico);
			 painelEspecifico = new JPanelPrincipalFinanceiroContas();
