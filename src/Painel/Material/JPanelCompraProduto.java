...
import TableModel.Produto.TMCompraMaterial;
...
public class JPanelCompraProduto extends JPanel implements
		ActionListener {
	...
	private TMCompraMaterial modelListaEstoque = new TMCompraMaterial();
	private TMCarrinhoCompra modelCarrinhoCompra = new TMCarrinhoCompra();
	private TMCompra modelFornecedor = new TMCompra();
