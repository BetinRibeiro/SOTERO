...
public class PainelMaterialPrimarioMaterial extends JPanel implements ActionListener {
	JPanel painelEspecifico = new PainelMaterialSecundarioCompraProduto();

	/**
	 * Create the panel.
	 */

	public PainelMaterialPrimarioMaterial() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Compra":
			...
			painelEspecifico = new PainelMaterialSecundarioCompraProduto();
		...
		case "Balan\u00E7o":
			remove(painelEspecifico);
			painelEspecifico = new PainelMaterialSecundarioBalancoProduto();
			add(painelEspecifico);
