...
public class PainelComercialPrimarioMenu extends JPanel implements ActionListener {
	JPanel painelEspecifico = new PainelComercialSecundarioVendaProduto();

	/**
	 * Create the panel.
	 */

	public PainelComercialPrimarioMenu() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Venda":
			remove(painelEspecifico);
			painelEspecifico = new PainelComercialSecundarioVendaProduto();
			add(painelEspecifico);
