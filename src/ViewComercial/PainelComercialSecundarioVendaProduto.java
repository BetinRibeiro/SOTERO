...
import modelTabela.ModelClienteVenda;
import modelTabela.ModelProdutosCarrinhoVenda;
import modelTabela.ModelProdutosComercialVenda;

@SuppressWarnings("serial")
public class PainelComercialSecundarioVendaProduto extends JPanel implements
		ActionListener {
	...
	private ModelProdutosComercialVenda modelListaEstoque = new ModelProdutosComercialVenda();
	private ModelProdutosCarrinhoVenda modelCarrinhoVenda = new ModelProdutosCarrinhoVenda();
	private ModelClienteVenda modelVendaCliente = new ModelClienteVenda();
	 ...
	 * Create the panel.
	 */
	public PainelComercialSecundarioVendaProduto() {
