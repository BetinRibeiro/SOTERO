...
public class PainelComercialSecundarioCadastroCliente extends JPanel implements
		ActionListener {
	...
	private ModelClienteCadastro model = new ModelClienteCadastro();
	 ...
	 * Create the panel.
	 */
	public PainelComercialSecundarioCadastroCliente() {
