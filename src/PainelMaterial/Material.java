...
public class Material extends JPanel implements ActionListener {
	JPanel painelEspecifico = new CompraProduto();
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Compra":
			...
			painelEspecifico = new CompraProduto();
